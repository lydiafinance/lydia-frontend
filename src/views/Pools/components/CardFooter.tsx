...
const CardFooter: React.FC<Props> = ({
  ...
  const imageSrc = `https://firebasestorage.googleapis.com/v0/b/lydiafinance-d806d.appspot.com/o/lyd_256XXX.png?alt=media&token=dd3bcce7-6f1e-4e49-8cb4-6c4ec712a7af`
      ...
      {isOpen && (
        <Details>
          <Row mb="4px">
            <FlexFull>
              <Label>
                <span role="img" aria-label="electrum">
                  🦁{' '}
                </span>
