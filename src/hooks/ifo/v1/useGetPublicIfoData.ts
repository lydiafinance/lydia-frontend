...
const useGetPublicIfoData = (ifo: Ifo): PublicIfoData => {
  ...
  const fetchIfoData = useCallback(async () => {
    ...
    const [startTimestamp, endTimestamp, poolBasic, poolUnlimited, taxRate] =
    ...
    setState((prev) => ({
      ...
      endTimestampNum,
      hasLockedToken,
      releasedPercent: new BigNumber(100),
      nextReleaseTimestamp: 2238697199000,
    }))
