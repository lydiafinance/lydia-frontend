...

          {
            ...
            <Box mt="16px">
              <Alert title={t("To participate in this sale...")}>
                <Text fontSize="14px" as="p">{t("You need to stake Lydian's Pool")}</Text>
              </Alert>
            </Box>
          }
        ...
        <>
          <TokenSection img={currencyImage} mb="24px">
            ...
            <Flex alignItems="center">
              <Value>{getBalanceAmount(userPoolCharacteristics.refundingAmountInLP, currency.decimals).toString()}</Value>
